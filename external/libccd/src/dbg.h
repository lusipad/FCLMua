...
#if defined(_KERNEL_MODE) && !defined(CCD_ENABLE_DEBUG_IO) && !defined(CCD_DISABLE_DEBUG_IO)
#define CCD_DISABLE_DEBUG_IO
#endif
 ...
 */
#if !defined(NDEBUG) && !defined(CCD_DISABLE_DEBUG_IO)
