...
typedef enum _FCL_SELF_TEST_SCENARIO_ID {
    ...
    FCL_SELF_TEST_SCENARIO_MEMORY = 6,
    FCL_SELF_TEST_SCENARIO_GEOMETRY = 7,
    FCL_SELF_TEST_SCENARIO_COLLISION_CORE = 8,
    FCL_SELF_TEST_SCENARIO_DISTANCE = 9,
    FCL_SELF_TEST_SCENARIO_UPSTREAM = 10,
    FCL_SELF_TEST_SCENARIO_DRIVER = 11,
